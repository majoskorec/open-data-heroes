...
#[ORM\Entity]
#[ORM\Table(name: 'declaration_business_status')]
class DeclarationBusinessStatus
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(targetEntity: AssetDeclaration::class, inversedBy: 'declarationBusinessStatus')]
