...
#[ORM\Entity]
#[ORM\Table(name: 'declaration_employment_status')]
class DeclarationEmploymentStatus
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(targetEntity: AssetDeclaration::class, inversedBy: 'declarationEmploymentStatus')]
