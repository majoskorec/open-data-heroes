...
#[ORM\Entity]
#[ORM\Table(name: 'declaration_other_function_status')]
class DeclarationOtherFunctionStatus
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(targetEntity: AssetDeclaration::class, inversedBy: 'declarationOtherFunctionStatus')]
